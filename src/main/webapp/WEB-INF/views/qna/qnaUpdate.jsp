		...
		<script type="text/javascript">
			$(function(){
				...
				$("#qnaUpdateBtn").click(function(){
					//입력값 체크
					if (!chkSubmit($('#qna_Title'),"제목을"))	 return;
		...
		<div class="contentContainer">
			...
			<div class="contentTB">
				<form id="f_writeForm" name="f_writeForm" enctype="multipart/form-data">
					<input type="hidden" id="qna_Num" name="qna_Num" value="${updateData.qna_Num}" />
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<td class="ac">글제목</td>
								<td colspan="3"><input type="text" name="qna_Title" id="qna_Title" value="${updateData.qna_Title}" /></td>
							</tr>
							<tr>
								<td class="ac vm">내용</td>
								<td colspan="3"><textarea name="qna_Content" id="qna_Content">${updateData.qna_Content}</textarea></td>
							</tr>
							<%-- <tr>
								<td class="ac">첨부파일</td>
								<td colspan="3"><input type="file" name="file" id="file">
								<span id="imgView">기존 이미지 파일명: ${updateData.qna_File}<span id="imgArea"></span></span>
								</td>
							</tr> --%>
							<tr>
								<td class="ac">비밀번호</td>
								<td colspan="3"><input type="password" name="qna_Pw" id="qna_Pw" /> 
