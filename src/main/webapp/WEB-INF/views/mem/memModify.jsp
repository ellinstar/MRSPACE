		...
		<div class="contentContainer">
			...
			<div class="well">
				...
				<input type="hidden" id="mem_Job" name="mem_Job" />
					...
					<div class="form-group form-group-sm">
						<label for="mem_Pw" class="col-sm-2 control-label">변경할 비밀 번호</label>
						<div class="col-sm-3">
							<input type="password" id="mem_Pw" name="mem_Pw" maxlength="20" class="form-control" placeholder="변경할 비밀번호 입력" >
						</div>
						<div class="col-sm-5">
							<p class="form-control-static error"></p>
						</div>
					...
					<div class="form-group form-group-sm">
						<label for="mem_PwCheck" class="col-sm-2 control-label">변경할 비밀번호 확인</label>
						<div class="col-sm-3">
							<input type="password"  id="mem_PwCheck" name="mem_PwCheck" maxlength="20" class="form-control" placeholder="변경할 비밀번호 입력 확인" >
						</div>
						<div class="col-sm-5">
							<p class="form-control-static error"></p>
						</div>
					...
					<div class="form-group form-group-sm">
						<label for="mem_Phone" class="col-sm-2 control-label">핸드폰 번호</label>
						<div class="col-sm-3">
							<input type="text" id="mem_Phone" name="mem_Phone" maxlength="11" class="form-control" value="${mem.mem_Phone}">	
						</div>
						<div class="col-sm-5">
							<p class="form-control-static error"></p>
						</div>
					...
					<div class="form-group form-group-sm">
						<label for="mem_Email" class="col-sm-2 control-label">회원 이메일</label>
						<div class="col-sm-3">
							<input type="email" id="mem_Email" name="mem_Email" maxlength="30" class="form-control" value="${mem.mem_Email}">
	 					</div>
						<div class="col-sm-3">
							<p class="form-control-static error"></p>
						</div>
					...
					<div class="form-group">	
						<div class="col-sm-offset-2 col-sm-6">
							<input type="button" value="수정하기" id="mem_Submit" class="btn btn-default" /> 
							<input type="button" value="돌아가기" id="mem_Cancel" class="btn btn-default" />
							<input type="button" value="회원탈퇴" id="mem_Delete" class="btn btn-default" />						
						</div>	
					</div>																										
				</form>
			</div>
