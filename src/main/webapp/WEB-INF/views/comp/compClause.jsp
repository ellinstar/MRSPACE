...
<section class="testimonials text-center bg-light">
   <form id="form" name="form">
      <h1>약관 동의</h1>
      <div>
         <textarea rows="12" readonly="readonly" style="resize: none;">제 1 조 (목적)
이 약관은 주식회사 MR스페이스(이하 “회사”)가 제공하는 “MRSPACE” 서비스(이하 “서비스”)의 호스트센터 (partner.spacecloud.kr) 이하 “센터” 이용과 관련하여 “회사”와 “호스트회원” 간의 권리와 의무 및 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2조 (용어의 정의)
1. 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
(1)   “서비스”라 함은 함은 유휴 공간(이하 “공간”) 정보의 공유 및 예약을 위하여 “회사”가 MRSPACE를 통해 제공하는 온라인 서비스 말합니다.
(2)   “회사”의 "서비스"에 접속하여 이용약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 "서비스"를 이용하는 고객은 서비스 이용목적에 따라 “게스트회원”과 “호스트회원”으로 구분됩니다.
A. 게스트회원 : “MRSPACE 게스트 이용약관”에 따라 “회사”와 이용계약을 체결하고 “회사”가 제공하는 “서비스”를 이용할 수 있는 회원을 말합니다.
B. 호스트회원 : 이 약관에 따라 “회사”와 이용계약을 체결하고 “회사”가 제공하는 “서비스”를 통해 “공간” 정보를 등록하거나 제안할 수 있는 회원을 말합니다.
(3)   "아이디"라 함은 "호스트회원"및 “호스트회원”이 지정한 관리자의 식별과 "서비스" 이용을 위하여 "호스트회원"이 정한 온라인 포털서비스의 아이디(ID)를 말합니다.
...
본 약관은 2016. 04. 05부터 시행 합니다.</textarea>
      </div>
      <div>
