		...
		<div class="well">
			<form id="myForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" name="cp_Id" id="cp_Id" placeholder="예) qwer8845"
						class="form-control">
					</div>
					<div class="col-sm-2">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="password" name="cp_Pw" id="cp_Pw" placeholder="예) asdf1234"
						class="form-control">
					</div>
					<div class="col-sm-5">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="password" name="cp_Pw2" id="cp_Pw2" placeholder="예) asdf1234"
						class="form-control">
					</div>
					<div class="col-sm-5">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" name="cp_Name" id="cp_Name" placeholder="예) 미래공간"
						class="form-control">
					</div>
					<div class="col-sm-5">
				...
				<div  class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" name="cp_Add" id="cp_Add"
						class="form-control" placeholder="예) 서울시 성동구 무학로2길 54">
					</div>
					<div class="col-sm-5">
				...
				<div  class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" name="cp_Bnum" id="cp_Bnum" onkeypress="return numkeyCheck(event)"
				...
				<div  class="form-group form-group-sm">
					...
					<div class="col-sm-3">
					<input type="text" id="cp_Account" name="cp_Account" id="cp_account"
						onKeyPress="return numkeyCheck(event)" placeholder="예) 3333-06-8802212"
						class="form-control">
					</div>
					<div class="col-sm-2">
				...
				<div  class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<input type="text" name="cp_Phone" id="cp_Phone" onkeyPress="return numkeyCheck(event)"
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-6">
						<input type="button" id="join" value="가입신청" class="btn btn-default" />
						 <input type="button" value="돌아가기" id="cp_Cancel" class="btn btn-default" />
					</div>
				</div>
